...
% Two choices in how to access the tidal harmonics:
% 1. - Get the 100MB tidal database netcdf file from
...
ncfile='c:\users\rsignell\documents\matlab\tri_tide_movie\adcirc54_38_orig.nc';

% 2. with Matlab 2012a+, we can access opendap directly:
%ncfile='http://geoport.whoi.edu/thredds/dodsC/usgs/vault0/models/tides/vdatum_gulf_of_maine/adcirc54_38_orig.nc'
...
%           Rerun by: Rich Signell (rsignell@usgs.gov)
...
%ax=[ -70.76  -70.60   41.48   41.57];   %woods hole region
...
start='18-Sep-2015 05:00';
stop= '18-Sep-2015 18:00';
